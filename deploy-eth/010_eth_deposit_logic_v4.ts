...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let ret_mDeposit_logic_v4 = await deploy('Deposit_logic_v4', {
    ...
    await fix.mDeposit_proxy.connect(users.proxy_admin).upgradeTo(ret_mDeposit_logic_v4.address)
};
export default func;
func.tags = ['Deposit_logic_v4'];
