...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let ret_mExitQueue_logic_v2 = await deploy('ExitQueue_logic', {
    ...
    await fix.mExitQueue_proxy.connect(users.proxy_admin).upgradeTo(ret_mExitQueue_logic_v2.address)
};
export default func;
func.tags = ['mExitQueue_logic_v2'];
