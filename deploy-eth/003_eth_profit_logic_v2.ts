...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let ProfitRecord_logic_v2 = await deploy('ProfitRecord_logic_v2', {
    ...
    await fix.mProfitRecord_proxy.connect(users.proxy_admin).upgradeTo(ProfitRecord_logic_v2.address)
};
export default func;
func.tags = ['profitRecord_logic_v2'];
