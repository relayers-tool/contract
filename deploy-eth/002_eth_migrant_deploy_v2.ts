...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let ret_mDeposit_logic_v2 = await deploy('Deposit_logic_v2', {
    ...
    await fix.mDeposit_proxy.connect(users.proxy_admin).upgradeTo(ret_mDeposit_logic_v2.address)
};
export default func;
func.tags = ['deploy_eth_migrant'];
