...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let ret_mDeposit_logic_v3 = await deploy('Deposit_logic_v3', {
    ...
    await fix.mDeposit_proxy.connect(users.proxy_admin).upgradeTo(ret_mDeposit_logic_v3.address)
};
export default func;
func.tags = ['Deposit_logic_v3'];
